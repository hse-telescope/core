...
func (s *Server) setRouter() *mux.Router {
	...
	mux.HandleFunc("/api/core/projects", s.createProjectHandler).Methods(http.MethodPost)
	mux.HandleFunc("/api/core/projects", s.getProjectsHanlder).Methods(http.MethodGet)
	mux.HandleFunc("/api/core/projects/{id}", s.deleteProjectHandler).Methods(http.MethodDelete)
	mux.HandleFunc("/api/core/projects/{id}", s.updateProjectHandler).Methods(http.MethodPut)
	mux.HandleFunc("/api/core/projects/{id}/graphs", s.GetProjectGraphsHandler).Methods(http.MethodGet)

	mux.HandleFunc("/api/core/graphs", s.createGraphHandler).Methods(http.MethodPost)
	mux.HandleFunc("/api/core/graphs/{id}", s.updateGraphHandler).Methods(http.MethodPut)
	mux.HandleFunc("/api/core/graphs/{id}", s.deleteGraphHandler).Methods(http.MethodDelete)
	mux.HandleFunc("/api/core/graphs/{id}/services", s.updateGraphServicesHandler).Methods(http.MethodPut)
	mux.HandleFunc("/api/core/graphs/{id}/relations", s.updateGraphRelationsHandler).Methods(http.MethodPut)
	mux.HandleFunc("/api/core/graphs/{id}/services", s.getGraphServicesHandler).Methods(http.MethodGet)
	mux.HandleFunc("/api/core/graphs/{id}/relations", s.getGraphRelationsHandler).Methods(http.MethodGet)
	mux.HandleFunc("/api/core/graphs/{id}/services", s.createGraphServicesHandler).Methods(http.MethodPost)
	mux.HandleFunc("/api/core/graphs/{id}/relations", s.createGraphRelationsHandler).Methods(http.MethodPost)

	mux.HandleFunc("/api/core/services", s.createServiceHandler).Methods(http.MethodPost)
	mux.HandleFunc("/api/core/services/{id}", s.updateServiceHandler).Methods(http.MethodPut)
	mux.HandleFunc("/api/core/services/{id}", s.deleteServiceHandler).Methods(http.MethodDelete)
	mux.HandleFunc("/api/core/services/{id}", s.getServiceHandler).Methods(http.MethodGet)

	mux.HandleFunc("/api/core/relations", s.createRelationHandler).Methods(http.MethodPost)
	mux.HandleFunc("/api/core/relations/{id}", s.updateRelationHandler).Methods(http.MethodPut)
	mux.HandleFunc("/api/core/relations/{id}", s.deleteRelationHandler).Methods(http.MethodDelete)
	mux.HandleFunc("/api/core/relations/{id}", s.getRelationHandler).Methods(http.MethodGet)
